...
/**
 * Given a package-qualified class name, return the approximate size of the
 * object in bytes.
 */
public final class ObjectSizeInterpreter {//implements Interpreter {
	...
	/**
	 * @param aLine
	 *            is a non-null, package-qualified name of a class.
	 * @param aResult
	 *            is a non-null, empty List which acts as an "out" parameter;
	 *            when returned, aResult must contain a non-null, non-empty List
